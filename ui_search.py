...
# Form implementation generated from reading ui file 'c:\Users\11577\Desktop\Coding\qtshow\search.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.biying = QtWidgets.QCheckBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.biying.sizePolicy().hasHeightForWidth())
        self.biying.setSizePolicy(sizePolicy)
        self.biying.setAutoExclusive(True)
        self.biying.setObjectName("biying")
        self.horizontalLayout.addWidget(self.biying)
        self.kuake = QtWidgets.QCheckBox(self.centralwidget)
        self.kuake.setAutoExclusive(True)
        self.kuake.setTristate(False)
        self.kuake.setObjectName("kuake")
        self.horizontalLayout.addWidget(self.kuake)
        ...
        self.gridLayout_2.addWidget(self.label_3, 3, 0, 1, 3, QtCore.Qt.AlignVCenter)
        spacerItem = QtWidgets.QSpacerItem(200, 160, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.biying.setText(_translate("MainWindow", "必应"))
        self.kuake.setText(_translate("MainWindow", "夸克"))
